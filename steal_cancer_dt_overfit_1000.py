...
# -----------------------------------------------------------------------------------------
shadow_data_train = generate_cancer_shadow(dataset, 1000)
shadow_data_test = generate_cancer_shadow(dataset, 1000)
# -----------------------------------------------------------------------------------------
...
in_prediction_set, out_prediction_set = create_in_out_prediction_set_cancer(shadow_data_train_predict,
